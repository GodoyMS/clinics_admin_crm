...
if(isset($_POST['submit_login'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      header("Location: https://alpha-clinicas.000webhostapp.com/clinicas/dashboard.php");
               echo 'success';
               phpinfo();
               die();
      ...
      <div class="md:flex md:items-center md:justify-center pt-14 sm:w-auto md:h-full w-4/5 xl:w-2/5 p-4  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
        <div class="max-w-md w-full space-y-8">
          ...
          <div class="text-center">
            ...
            <p class="my-2 text-sm text-gray-500">Por favor ingresa tus datos para ingresar a tu cuenta</p>
            <p class="text-start text-sm text-gray-500">Demo</p>
            <p class="text-start text-xs text-gray-500">Dni: 71102795</p>
